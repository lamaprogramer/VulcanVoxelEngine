...
std::vector<uint16_t> CubeObject::cubeIndices = {
		0,1,2, 2,3,0,
		1,5,6, 6,2,1,
		7,6,5, 5,4,7,
		4,0,3, 3,7,4,
...
CubeObject::CubeObject(VulkanPhysicalDevice physicalDevice, VulkanLogicalDevice device, VulkanCommandPool commandPool, glm::mat4 matrix) : 
	BasicObject{
		physicalDevice,
		device,
		commandPool,
