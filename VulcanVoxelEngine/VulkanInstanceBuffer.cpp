...
VulkanInstanceBuffer::VulkanInstanceBuffer(VulkanPhysicalDevice physicalDevice, VulkanLogicalDevice device, VulkanCommandPool commandPool, VkDeviceSize bufferSize, VkMemoryPropertyFlags properties) :
    VulkanBuffer{
        physicalDevice,
        device,
        bufferSize,
